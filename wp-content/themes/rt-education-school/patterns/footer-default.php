...
return array(
    ...
    'content'    => '<!-- wp:group {"style":{"elements":{"link":{"color":{"text":"var:preset|color|fourground"}}},"background":{"backgroundImage":{"url":"http://localhost:10010/wp-content/themes/rt-education-school/assets/images/footer-bg.png","id":36,"source":"file","title":"footer-bg"}}},"textColor":"background","layout":{"type":"constrained","contentSize":"80%"}} -->
...
<!-- wp:navigation-link {"label":"Marketing","type":"","url":"#","kind":"custom","isTopLevelLink":true} /-->
...
<!-- wp:navigation {"overlayMenu":"never","className":"is-head-menu","layout":{"type":"flex","justifyContent":"left","orientation":"vertical"},"fontFamily":"saira"} -->
